...
import {Transfer, OHM_V2} from "../generated/OHM_V2/OHM_V2"
...
export function handleTransfer(event: Transfer): void {
    let contractAddress = Address.fromString(Addresses.OHM_V2_ERC20_CONTRACT)
...
// Check the token and update the total supply
    let contract = OHM_V2.bind(Address.fromString(Addresses.OHM_V2_ERC20_CONTRACT))
